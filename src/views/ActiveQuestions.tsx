...
import { Clock, Users, Activity, Trash2, Link as LinkIcon, CheckCircle2, Pencil, X, Calendar, Plus, Save, Share2, Zap, Power } from 'lucide-react';
...
export function ActiveQuestions({ 
  ...
  const [selectedGroupIdForShare, setSelectedGroupIdForShare] = useState<string | undefined>(undefined);
  ...
  const groupedActiveQuestions = useMemo(() => {
  ...
  const { targetQuestions, submissions } = useMemo(() => {
                    ...
                    <div>
                      <div className="flex items-center justify-between text-xs font-medium text-slate-500 mb-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={() => {
                              if (window.confirm('Deactivate this question? It will be moved to past questions.')) {
