  ...
  return (
    <div className="min-h-screen bg-[#0a1128] text-slate-200 p-6 md:p-12 font-sans selection:bg-blue-500/30">
      <div className="max-w-3xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <h2 className="text-xl md:text-2xl font-semibold text-white leading-relaxed">
                    <span className="text-blue-500 mr-2">Q{currentQuestionIndex + 1}.</span> {q.text}
                  </h2>
                </div>
        ...
        <div className="bg-[#0f172a] rounded-2xl border border-blue-900/50 p-6 md:p-8 mt-8 shadow-xl text-center flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex gap-4 w-full md:w-auto order-2 md:order-1">
            <button
              onClick={() => setCurrentQuestionIndex(prev => Math.max(0, prev - 1))}
              disabled={currentQuestionIndex === 0}
              className="px-6 py-3 bg-slate-800 hover:bg-slate-700 text-white rounded-xl font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed flex-1 md:flex-none"
            >
              Previous
            </button>
            <button
          ...
          <div className="w-full md:w-auto order-1 md:order-2">
            {isSubmitted ? (
              <button
                ...
                className="px-8 py-3 bg-[#25D366] hover:bg-[#1ebd57] text-white rounded-xl font-bold shadow-[0_0_15px_rgba(37,211,102,0.3)] hover:shadow-[0_0_25px_rgba(37,211,102,0.5)] transition-all flex items-center justify-center gap-3 w-full"
              >
